...
=============================
This project is a module to work with frappe framework **version 6.4 and above**. It integrate [JasperReports](http://community.jaspersoft.com/project/jasperreports-library) with frappe framework.
